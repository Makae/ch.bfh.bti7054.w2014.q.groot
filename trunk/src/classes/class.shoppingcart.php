	...
	public function emptyCart() {
	 ...
	 public function displayCart() {
	 	...
	 	$table = "<br>In ihrem Warenkorb befinden sich: ".sizeof($this->items)." Elemente".
	 	 	"<table border='1' id='shoppingTable'>".
	 	 	"<tr id='tableTopics'><td>Artikel-Nr.</td><td>Anzahl</td><td></td><td></td><td>Preis</td>";
			...
			$ID2del=$index->ID;
	 	 	...
	 	 	<td></td>
	 	 	<td><form action='http://localhost/grootprod/index.php?view=shoppingcart&remove=$ID2del' method='post'><input type='submit' value='Remove'></input></form></td>
	 	 	</tr>"; 
